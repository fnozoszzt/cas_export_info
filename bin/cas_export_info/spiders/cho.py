...
class choSpider(spiders.MySpider):
    ...
    def expert_list_parse(self, response):
        ...
        expert_list = response.selector.xpath('.//td[@width="115"]/a')
    ...
    def analy(self, response):
        ...
        info_list_1 = response.selector.xpath('//td[@class="detail_content"]/table/tr[1]//table/tbody/tr')
        for sub_info in info_list_1:
            ...
            if len(l) % 2 == 0:
                for i in range(0, len(l), 2):
                    ...
                    res[key] = value
        info_list_2 = response.selector.xpath('//td[@class="detail_content"]/table/tr[2]//td[@height="420"]/table//table')
