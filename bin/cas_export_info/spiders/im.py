...
class imSpider(spiders.MySpider):
    ...
    def expert_list_parse(self, response):
        ...
        url = response.url
        expert_list = response.selector.xpath('.//td[@class="black_14"]//a') + response.selector.xpath('.//td[@style="background: #f8f8f8;"]//a')
    ...
    def analy(self, response):
        ...
        info_list_1 = response.selector.xpath('//table[@width="540px"]//tr')
